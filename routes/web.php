...
Route::prefix('{locale?}')->middleware(['web', 'set-language'])->group(function () {
    ...
    Route::get('admin/login', [RegisterController::class, 'showLoginForm'])->name('backpack.auth.login');
    Route::post('admin/login', [RegisterController::class, 'login'])->name('backpack.auth.login');
});
