...
var plinkoSettings = {
	...
	prizes: [
		...
		{ value: 0, text: "0", fontSize: 20, lineHeight: 18, x: 0, y: 5, color: "#fff", bgColor: "#7700B0", bgWinColor: "#A600F9", percent: 100 },
		...
		{ value: 500, text: "5\n0\n0", fontSize: 20, lineHeight: 18, x: 0, y: -8, color: "#fff", bgColor: "#7700B0", bgWinColor: "#A600F9", percent: 0 },
		{ value: 0, text: "0", fontSize: 20, lineHeight: 18, x: 0, y: 5, color: "#fff", bgColor: "#7700B0", bgWinColor: "#A600F9", percent: 0 },
		{ value: 250, text: "2\n5\n0", fontSize: 20, lineHeight: 18, x: 0, y: -8, color: "#fff", bgColor: "#7700B0", bgWinColor: "#A600F9", percent: 00 },
...
var textDisplay = {
	...
	exitMessage: "QUITTER LA PARTIE ?",
	share: "PARTAGEZ LE SCORE",
	resultTitle: "FIN DE PARTIE",
	resultDesc: "VOUS GAGNEZ",
	resultScore: "[NUMBER]",
	coutPartie: "UNE PARTIE COUTE 100"
}

//Social share, [SCORE] will replace with game score
var shareEnable = true; //toggle share
var shareTitle = "J'ai gagné [SCORE] diamants au Super Plinko sur le site GoKDO.com";//social share score title
var shareMessage = "[SCORE] diamants m'ont été attribués pour gagner des cadeaux au jeu Super Plinko du site GoKDO ! Venez jouer !"; //social share score message
...
function goPage(page) {
	...
	switch (page) {
		...
		case 'result':
			...
			TweenMax.to(tweenData, 1, {
				resultScore: playerData.score, overwrite: true, onUpdate: function () {
...
function startAnimate(obj) {
	TweenMax.to(obj, obj.tween.startSpeed, {
		delay: obj.tween.startDelay, alpha: obj.tween.startAlpha, overwrite: true, onComplete: function () {
			TweenMax.to(obj, obj.tween.endSpeed, {
				delay: obj.tween.endDelay, alpha: obj.tween.endAlpha, overwrite: true, onComplete: function () {
					if (obj.tween.loop) {
						startAnimate(obj)
					}
				}
...
function checkWinBonusPoint() {
	if (gameData.dropCon && !gameData.resultBonusCon) {
		...
		TweenMax.to(plinkoBonusContainer, 3, {
			overwrite: true, onComplete: function () {
				toggleGameStat();
...
function displayBonusText() {
	...
	TweenMax.to(itemBonus, 1, {
		alpha: 1, y: itemBonus.oriY, ease: Expo.easeOut, overwrite: true, onComplete: function () {
			TweenMax.to(itemBonus, 1, {
				alpha: 0, y: itemBonus.oriY - 50, ease: Expo.easeIn, overwrite: true, onComplete: function () {
					TweenMax.to(itemBonus, 0, {
						delay: .5, overwrite: true, onComplete: function () {
							itemBonus.visible = false;
