...
var guideline, bg, logo, buttonStart, buttonAchatRubis, imgDiamants, buttonRestart, buttonFacebook, buttonTwitter, buttonWhatsapp, buttonFullscreen, buttonSoundOn, buttonSoundOff;
...
function buildGameCanvas(){
	...
	/* BUTTON ACHETER DES RUBIS */
	buttonAchatRubis = new createjs.Bitmap(loader.getResult('buttonAchatRubis'));
	centerReg(buttonAchatRubis);
	buttonAchatRubis.x = canvasW/2;
	buttonAchatRubis.y = canvasH/100 * 80;

	// DIAMANTS
	imgDiamants = new createjs.Bitmap(loader.getResult('imgDiamants'));
	centerReg(imgDiamants);
	imgDiamants.x = canvasW/2 * 1.408;
	imgDiamants.y = canvasH/100 * 19.3;
	...
	//Texte affiche le cout d'une partie
	cpTxt = new createjs.Text();
	cpTxt.font = "20px azonixregular";
	cpTxt.lineHeight = 35;
	cpTxt.color = "#fff";
	cpTxt.textAlign = "center";
	cpTxt.textBaseline='alphabetic';
	cpTxt.text = textDisplay.coutPartie;
	cpTxt.x = canvasW/2;
	cpTxt.y = canvasH/100 * 20;
	
	mainContainer.addChild(cpTxt);
	...
	mainContainer.addChild(logo, buttonAchatRubis);
	mainContainer.addChild(logo, imgDiamants);	
