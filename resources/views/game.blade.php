                     ...
                     <section class="p-4 overflow-hidden text-gray-100 bg-gray-800 rounded-md">
                         ...
                         <div class="container flex flex-col-reverse xl:flex-row">
                             ...
                             <div class="display-block">
                                <button class="w-full px-2 py-2 rounded-md text-white bg-green-800 border-green-700 active:bg-blue-600 hover:bg-green-600 focus:ring-opacity-75" id="fullscreenButton">JOUER EN MODE PLEIN ECRAN</button>
                            </div> 
