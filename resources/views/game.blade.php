...
<div class="w-full">
    ...
    <button id="methode1" class="w-full inline px-2 py-2 text-white bg-blue-600 border-gray-700 rounded-md active:bg-blue-600 hover:bg-blue-400 focus:ring-opacity-75">Méthode 1</button>
    <button id="methode2" class="w-full inline px-2 py-2 text-white bg-blue-600 border-gray-700 rounded-md active:bg-blue-600 hover:bg-blue-400 focus:ring-opacity-75">Méthode 2</button>
        ...
        // Afficher iframe1 lorsque Méthode 1 est cliqué
        methode1Button.addEventListener('click', () => {
            iframe1.style.display = 'block';
            iframe2.style.display = 'none';
        });

        // Afficher iframe2 lorsque Méthode 2 est cliqué
        methode2Button.addEventListener('click', () => {
