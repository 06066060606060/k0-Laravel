                     ...
                     <section class="p-4 overflow-hidden text-gray-100 bg-gray-800 rounded-md">
                         ...
                         <div class="container flex flex-col-reverse xl:flex-row">
                            ...
                            <h1 class="font-extrabold text-md text-gray-50">SCORE:</h1>
                             ...
                             <iframe id="gameBody" src="{{ $link . '?userid=' . $userid . '&tk=' . csrf_token() . '&user_name=' . $username . '&rubis=' . $rubis . '&gameid=' $game->id . '&free_game=' . $free }}" class="w-full h-[667px] overflow-hidden -mt-1"
                                 scrolling="no"></iframe>
                                @else
