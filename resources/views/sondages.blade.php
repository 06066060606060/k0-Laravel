...
<div data-barba="container">
	...
	<section class="mb-2 relative text-white body-font">
  		<h2 class="mb-1 text-3xl font-bold text-blue-500 title-font">Top 10 Sondages Rémunérés</h1>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">1. <a href="https://gokdo.com">Gokdo</a></h2>
    <p class="mt-2 mb-2">Gokdo propose des sondages rémunérés, les membres peuvent gagner de l'argent en complétant des sondages rémunérés, Gokdo offre la moitié de ses revenus aux membres soit 50% des gains qu'ils perçoivent, si Gokdo gagne 1€ il reverse automatiquement 0.50€ ce qui le position en haut de ce top 10 sondages rémunérés.</p>

    <h2 style="color:yellow;" class="mb-1 mt-2 text-xl font-bold text-yellow title-font">2. <a href="https://www.swagbucks.com/?lang=fr">Swagbucks</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">3. <a href="https://www.toluna.com/fr-FR/">Toluna</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">4. <a href="https://www.surveyjunkie.com/">Survey Junkie</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">5. <a href="https://vindaleresearch.fr/">Vindale Research</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">6. <a href="https://fr.yougov.com/">YouGov</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">7. <a href="https://www.gaddin.com/">Gaddin</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">8. <a href="https://www.sondagesremuneres.fr/">SondagesRémunérés.fr</a></h2>
    ...
    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">9. <a href="https://members.pineconeresearch.com/">Pinecone Research</a></h2>
    <p class="mt-2 mb-2">Pinecone Research est une plateforme exclusive qui propose des sondages rémunérés. Les participants peuvent gagner de l'argent ou des points échangeables contre des prix en participant à des enquêtes en ligne.</p>

    <h2 style="color:yellow;" class="mb-1 text-xl font-bold text-yellow title-font">10. <a href="https://www.inboxdollars.com/">InboxDollars</a></h2>
    <p class="mt-2 mb-2">InboxDollars offre diverses façons de gagner de l'argent en ligne, y compris des sondages rémunérés. Les membres peuvent gagner des récompenses en espèces pour leurs opinions et d'autres activités en ligne.</p>
