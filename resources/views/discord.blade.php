        ...
        <div class="flex flex-col max-w-5xl pb-8 mx-auto mb-8 overflow-hidden rounded">
            <section class="relative text-gray-600 body-font">
                <div class="container px-5 py-8 mx-auto">
                    ...
                    <div class="center text-center mt-8"><a href="#"><i class="fab fa-10x fa-discord" style="color:yellow;"></i></a><br><a href="#" style="color:yellow; font-weight:bold;" class="text-4xl">{{__('REJOINS-NOUS')}}</a></div>
                </div>
            </section>
        </div>
    </div>
