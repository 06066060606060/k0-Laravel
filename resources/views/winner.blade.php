         ...
         <container class="flex flex-col min-h-screen px-8 mx-auto md:flex-row lg:max-w-6xl md:pl-16">
             <div class="container px-5 pt-8 mx-auto">
                 <div class="flex flex-col w-full mb-20 text-center">
                     ...
                     <p class="text-gray-300">Attention: il faudra impérativement que chaque membre parrainé remplisse 1 sondage pour qu'il soit prit en compte dans le classement, lors de la fin du concours des vérifications seront effectuées et chaque membre parrainé qui n'aura pas complété au moins 1 sondage sera retiré des points de concours du parrain.</p>
