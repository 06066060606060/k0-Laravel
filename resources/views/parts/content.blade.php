...
@endif
   <i class="fa-sharp fa-regular fa-rocket pr-2 fa-sm" style="color: #005eff;"></i> {!! __("<b>Le saviez-vous :</b> Les <img src='img/gem10.png' class='w-5 h-5 inline-block'> vous permettent de jouer plus de parties, vous pouvez en acheter via le lien Pack de notre menu.") !!}</p>
