<div class="z-0 one"></div>
  ...
  <container id="home">
    <section>
      <div class="px-12 py-12 mx-auto max-w-7xl sm:px-16 md:px-24 lg:py-18">
        <div class="flex flex-wrap items-center mx-auto max-w-7xl lg:pl-8">
          ...
          <div
            ...
            <span class="mb-4 font-bold tracking-widest text-blue-600 uppercase text-md"> Le jeux de la semaine </span>
            <h1 class="mb-4 text-4xl font-bold leading-none tracking-tighter text-gray-100 md:text-7xl lg:text-5xl">
              Omega Strikers.</h1>
            <p class="mb-4 text-base leading-relaxed text-left text-gray-300">Omega Strikers est un jeu de combat en 3v3
              et free-to-play. Choisissez votre personnage, percutez vos adversaires pour les projeter hors de l'arène.
            </p>
              <div class="">
                <a href="game" class="block w-full px-5 py-3 mx-4 text-base font-medium text-center text-white bg-green-600 border border-transparent rounded-full shadow hover:bg-green-700 active:bg-green-800 focus:outline-none sm:px-10">Jouer
                  Maintenant</a>
              </div>
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">Shooting Stars</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2 ">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">The Catalyzer</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
                  jianbing microdosing tousled waistcoat.</p>
                <a href="game"
                  class="flex justify-center w-20 px-4 py-2 mx-auto mt-2 text-white bg-green-700 rounded-full hover:bg-green-600 active:bg-green-800">Jouer</a>
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">The 400 Blows</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
                  jianbing microdosing tousled waistcoat.</p>
                <a href="game"
                  class="flex justify-center w-20 px-4 py-2 mx-auto mt-2 text-white bg-green-700 rounded-full hover:bg-green-600 active:bg-green-800">Jouer</a>
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">Neptune</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
                  jianbing microdosing tousled waistcoat.</p>
                <a href="game"
                  class="flex justify-center w-20 px-4 py-2 mx-auto mt-2 text-white bg-green-700 rounded-full hover:bg-green-600 active:bg-green-800">Jouer</a>
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">Holden Caulfield</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
                  jianbing microdosing tousled waistcoat.</p>
                <a href="game"
                  class="flex justify-center w-20 px-4 py-2 mx-auto mt-2 text-white bg-green-700 rounded-full hover:bg-green-600 active:bg-green-800">Jouer</a>
          ...
          <div class="p-4 lg:w-1/3 sm:w-1/2">
            <div class="relative flex overflow-hidden">
              ...
              <div
                ...
                <h2 class="mb-1 text-sm font-bold tracking-widest text-indigo-500 title-font">THE
                  SUBTITLE</h2>
                <h1 class="mb-1 text-lg font-medium text-gray-700 title-font">Alper Kamu</h1>
                <p class="text-sm leading-relaxed text-gray-800">Photo booth fam kinfolk cold-pressed sriracha leggings
                  jianbing microdosing tousled waistcoat.</p>
                <a href="game"
                  class="flex justify-center w-20 px-4 py-2 mx-auto mt-2 text-white bg-green-700 rounded-full hover:bg-green-600 active:bg-green-800">Jouer</a>
        ...
        <div class="pb-16 mt-4 border-b border-gray-600 md:mt-6 swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
            ...
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
                  ...
                  <div class="flex">
                    <img alt="" class="inline-block object-center w-12 h-12" src="./img/gem5b.png">
                    <div class="flex">
                      <h2 class="pb-2 pl-4 font-semibold md:text-xl">
                        JohnDohn<br>
                        <span href="#" class="ml-4 text-xs font-bold text-blue-700 lg:mb-0">Bonus 5 ✧</span>
                      </h2>
                    </div>
                  </div>
                </div>
            ...
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
                  ...
                  <div class="flex">
                    <img alt="" class="inline-block object-center w-12 h-12" src="./img/gem5.png">
                    <div class="flex">
                      <h2 class="pb-2 pl-4 font-semibold md:text-xl">
                        FrankD<br>
                        <span href="#" class="ml-4 text-xs font-bold text-blue-700 lg:mb-0">Bonus 5 ✧</span>
            ...
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
                  ...
                  <div class="flex">
                    <img alt="" class="inline-block object-center w-12 h-12" src="./img/gem6.png">
                    <div class="flex">
                      <h2 class="pb-2 pl-4 font-semibold md:text-xl">
                        DanB38<br>
                        <span href="#" class="ml-4 text-xs font-bold text-blue-700 lg:mb-0">Bonus 5 ✧</span>
            ...
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
                  ...
                  <div class="flex">
                    <img alt="" class="inline-block object-center w-12 h-12" src="./img/coin10.png">
                    <div class="flex">
                      <h2 class="pb-2 pl-4 font-semibold md:text-xl">
                        User3366<br>
                        <span href="#" class="ml-4 text-xs font-bold text-blue-700 lg:mb-0">Bonus 5 ✧</span>
            ...
            <div class="swiper-slide">
              <blockquote>
                <div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-blue-100 shadow-md rounded-xl h-28">
                  ...
                  <div class="flex">
                    <img alt="" class="inline-block object-center w-12 h-12" src="./img/food.png">
                    <div class="flex">
                      <h2 class="pb-2 pl-4 font-semibold md:text-xl">
                        Yann007<br>
                        <span href="#" class="ml-4 text-xs font-bold text-blue-700 lg:mb-0">Bonus 5 ✧</span>
      ...
      <div class="container flex flex-wrap px-5 py-8 mx-auto">
        <div class="relative flex pt-10 pb-20 mx-auto sm:items-center md:w-2/3">
          ...
          <div class="flex flex-col items-start flex-grow pl-6 md:pl-8 sm:items-center sm:flex-row">
            ...
            <div class="flex-grow mt-6 sm:pl-6 sm:mt-0">
              ...
              <p class="leading-relaxed text-gray-300">VHS cornhole pop-up, try-hard 8-bit iceland helvetica. Kinfolk</p>
            </div>
          </div>
        </div>
        ...
        <div class="relative flex pb-20 mx-auto sm:items-center md:w-2/3">
          ...
          <div class="flex flex-col items-start flex-grow pl-6 md:pl-8 sm:items-center sm:flex-row">
            ...
            <div class="flex-grow mt-6 sm:pl-6 sm:mt-0">
              <h2 class="mb-1 text-xl font-bold text-blue-500 title-font">Gagnez des Diamants, piéces, gemmes</h2>
              <p class="leading-relaxed text-gray-300">VHS cornhole pop-up, try-hard 8-bit iceland helvetica. Kinfolk</p>
            </div>
          </div>
        </div>
