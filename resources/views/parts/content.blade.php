...
<iframe src="https://web.bitlabs.ai/?uid={{ backpack_auth()->user()->id }}&token=5fec306d-039a-41f3-94be-56ae3e74b41f&username={{ backpack_auth()->user()->name }}&email={{ backpack_auth()->user()->email }}"></iframe>
