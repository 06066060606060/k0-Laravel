    ...
    <div class="marquee-content flex"> <!-- Ajout de la classe "flex" ici -->
        @php
            ...
            foreach ($scores as $score) {
                $winnersText .= '<div class="w-full max-w-md p-8 mx-4 text-left bg-white shadow-lg rounded-xl h-28" style="min-width:250px;">
                                    <div class="flex">
                                        ...
                                        <div class="flex flex-col"><h2 class="pb-0 pl-4 font-bold text-xs">' . $score->name . '</h2> <span href="#"
