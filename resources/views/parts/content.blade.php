...
@endif
    {!! __("Le saviez-vous : Les <img src='img/gem10.png' class='w-8 h-6' style='display:inline;'> Rubis vous permettent de jouer plus de parties, vous pouvez en acheter via le lien Pack de notre menu.") !!}</p>
