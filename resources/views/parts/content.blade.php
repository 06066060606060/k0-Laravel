            ...
            <div class="inline-block w-full max-w-4xl pt-32 mx-auto overflow-hidden transition-all transform">
                <div class="flex flex-col mt-6 mb-0 bg-gray-800 rounded-md shadow-2xl">
                    ...
                    <div class="bg-gray-700 rounded-b-md">
                        ...
                        <div class="flex items-center justify-center pb-8 mx-20 mt-8">
                            <p class="text-red-600 bg-white rounded-md py-4 mx-4 font-bold text-s">Les comptes expirés qui n'auront pas régler leur abonnement mensuel au dela de 25 jours seront automatiquement supprimés !</p>
                        </div>
                        ...
                        <div class="w-1/1 p-4 lg:w-1/1">
                            <div class="relative flex overflow-hidden max-h-[150px] md:max-h-full">
                                <a href="{{ $locale }}/game/{{ $eventsgame->id }}">
                                    ...
                                    @endphp
                                    <img alt="gallery" class="absolute inset-0 object-cover object-center w-full h-full rounded-md imggame animate__animated animate__pulse" src="{{ $gifiUrl }}" onerror="this.src='/img/empty.png'">
                                    <div class="relative z-10 w-full p-4 transition duration-200 bg-blue-100 border-4 border-gray-200 rounded-lg opacity-0 hover:opacity-100">
                                        ...
                                        @endif
                                        <a href="{{ $locale }}/game/{{ $eventsgame->id }}" onclick="event.preventDefault(); window.location.reload(true); window.location.href='{{ $locale }}/game/{{ $eventsgame->id }}';" class="relative flex justify-center w-24 px-5 py-2 mx-auto mt-4 font-medium text-white shadow-lg group">
                    ...
                    @empty
                        <div class="p-4 lg:w-1/3 sm:w-1/2">
                            <div class="relative flex overflow-hidden">
                                ...
                                <img alt="gallery" class="absolute inset-0 object-cover object-center w-full h-full rounded-md animate__animated animate__pulse" src="./img/empty.png">
                        ...
                        <div class="relative flex overflow-hidden max-h-[150px] md:max-h-full">
                            <a href="{{ $locale }}/game/{{ $allgame->id }}">
                                ...
                                <div class="relative z-10 w-full p-4 transition duration-200 bg-blue-100 border-4 border-gray-200 rounded-lg opacity-0 hover:opacity-100">
                                    ...
                                    @endif
                                    <a href="{{ $locale }}/game/{{ $allgame->id }}" onclick="event.preventDefault(); window.location.reload(true); window.location.href='{{ $locale }}/game/{{ $allgame->id }}';" class="relative flex justify-center w-24 px-5 py-2 mx-auto mt-4 font-medium text-white shadow-lg group">
                                        <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform translate-x-0 -skew-x-12 bg-indigo-500 group-hover:bg-indigo-700 group-hover:skew-x-12"></span>
                                        <span class="absolute inset-0 w-full h-full transition-all duration-300 ease-out transform skew-x-12 bg-indigo-700 group-hover:bg-indigo-500 group-active:bg-indigo-600 group-hover:-skew-x-12"></span>
                                        <span class="absolute bottom-0 left-0 hidden w-10 h-20 transition-all duration-100 ease-out transform -translate-x-8 translate-y-10 bg-indigo-600 -rotate-12"></span>
                                        <span class="absolute bottom-0 right-0 hidden w-10 h-20 transition-all duration-100 ease-out transform translate-x-10 translate-y-8 bg-indigo-400 -rotate-12"></span>
                    ...
                    <div class="w-1/2 p-4 lg:w-1/2">
                        ...
                        <a href="{{ $locale }}/game/{{ $sologame->id }}">
                            ...
                            <div
                                ...
                                @endif
                                @endif
                                    <a href="{{ $locale }}/game/{{ $sologame->id }}" onclick="event.preventDefault(); window.location.reload(true); window.location.href='{{ $locale }}/game/{{ $sologame->id }}';"
