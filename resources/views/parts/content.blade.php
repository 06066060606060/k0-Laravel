...
@endif
   <i class="fas fa-bullhorn text-white"></i>" {!! __("Le saviez-vous : Les <img src='img/gem10.png' class='w-5 h-5 inline-block'> vous permettent de jouer plus de parties, vous pouvez en acheter via le lien Pack de notre menu.") !!}</p>
