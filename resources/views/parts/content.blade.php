        ...
        <div class="marquee-content pb-4 mt-4 border-gray-600 md:mt-4 swiper-container swiper-initialized swiper-horizontal swiper-backface-hidden">
             @php
                ...
                foreach ($scores as $score) {
                    $winnersText .= '<div class="swiper-slide">
                                <blockquote><div class="flex flex-col w-full max-w-md p-8 mx-4 text-left bg-white shadow-lg rounded-xl h-28">
                                        <div class="flex">
<img alt="" class="inline-block object-center w-auto h-' . ($isMobile ? '9' : '12') . '" src="https://i.pinimg.com/originals/5c/15/c1/5c15c1539c9c566b5413d98f9cf3592f.png"> <b>' . $score->name . '</b> <br>à gagné <b>' . $score->cadeau_name . '</b></div></div></blockquote></div>   ';
                }
            @endphp
            {!! $winnersText !!} <
        </div>
