    ...
    <nav x-data="{ isOpen: false }" class="container py-6 pl-2 pr-4 mx-auto lg:flex lg:justify-between lg:items-center">
        ...
        <!-- Mobile Menu open: "block", Menu closed: "hidden" -->
                    ...
                    <button @click="isOpen = !isOpen"
                        ...
                        en<img src="https://flagicons.lipis.dev/flags/4x3/gb.svg" alt="English">
                        @elseif(ucfirst(LaravelLocalization::getCurrentLocaleNative()) == "Français")
                        fr<img src="https://flagicons.lipis.dev/flags/4x3/fr.svg" alt="Français">
                        @elseif(ucfirst(LaravelLocalization::getCurrentLocaleNative()) == "Español")
                        es<img src="https://flagicons.lipis.dev/flags/4x3/es.svg" alt="Español">
                        @else
                        @endif
                        </span>
