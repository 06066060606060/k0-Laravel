<header class="z-10 flex px-4 pt-6 pb-2 mx-auto max-w-7xl border-x-1 justify-evenly">
    <nav x-data="{ isOpen: false }" class="container p-6 mx-auto lg:flex lg:justify-between lg:items-center">
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
            ...
            @else
                <a class="block h-10 px-5 py-2 mt-4 text-sm text-center text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg lg:mt-0 hover:bg-blue-700 active:bg-blue-800 lg:w-auto"
                    href="/admin">
                    Connexion
                </a>
            @endif
