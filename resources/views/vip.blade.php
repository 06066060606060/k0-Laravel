...
"><span class="inline-flex">15 000 <img src="/img/diamond5.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 text-lg font-bold bg-white text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">10 Packs Mini achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">125 000 <img src="/img/diamond5.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">50 Packs Mini achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">75 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">100 Packs Mini achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">150 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">500 Packs Mini achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black"><span class="inline-flex">100 <img src="/img/coin10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
</table>
...
"><span class="inline-flex">400 000 <img src="/img/diamond5.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">50 Packs Starter achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">100 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">100 Packs Starter achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">200 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">500 Packs Starter achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black"><span class="inline-flex">200 <img src="/img/coin10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
</table>
...
">5 Packs Booster achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">120 000 <img src="/img/diamond5.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 text-lg font-bold bg-white text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
">20 Packs Booster achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">800 000 <img src="/img/diamond5.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
...
">200 Packs Booster achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black" style="border-bottom: 1px solid rgb(55 65 81 / var(--tw-bg-opacity));
"><span class="inline-flex">400 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">500 Packs Booster achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">800€<br><span class="inline-flex">250 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
</table>
...
"><span class="inline-flex">100 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  ...
  <tr>
    ...
    <td class="border-white py-4 bg-white text-lg font-bold text-black">10€<br><span class="inline-flex">250 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
</table>
...
"><span class="inline-flex">100 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  ...
  <tr>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">500 Packs Tera achetés</td>
    <td class="border-white py-4 bg-white text-lg font-bold text-black">10€<br><span class="inline-flex">250 <img src="/img/gem10.png" class="ml-2 mt-1 w-7 h-6"></span></td>
  </tr>
</table>
