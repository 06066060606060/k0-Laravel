...
<div data-barba="container">
	...
	<section class="mb-2 relative text-gray-600 body-font">
		...
		<p class="leading-relaxed mb-4 text-gray-300">{{__("Le tableau ci-dessous vous aide à comprendre le fonctionnement du VIP, nous enregistrons chaque achat de votre part par type de Pack et nous vous récompensons lorsqu'un palier est atteint.")}}</p>
